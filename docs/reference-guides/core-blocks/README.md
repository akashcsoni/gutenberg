...
-	**Category:** [widgets](https://developer.wordpress.org/block-editor/reference-guides/core-blocks/core-blocks-widgets/)
-	**Supports:** align (center, left, right), anchor, color (background, gradients, text), dimensions (width), interactivity, spacing (margin), typography (fontSize, lineHeight), ~~html~~
